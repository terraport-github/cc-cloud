<x-layout.main>
    <?php
        $document_kind = App\Enums\DocumentKind::tryFrom($document_kind);
    ?>
...
<?php /*
        @forelse ($documents as $document)
            <div class="d-flex flex-row-reverse bd-highlight mb-2">
                <button class="btn btn-primary" onclick="location.href='{{ route('document.edit', ['school_id' => $document,'document_kind' => $document_kind]) }}'">編集</button>
            </div>
            <div class="card shadow-sm mb-3">
